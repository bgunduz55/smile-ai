...
export class LMStudioService extends BaseLLMService {
    ...
    constructor(
        ...
        this.endpoint = this.settingsService.getConfiguration<string>('lmstudio.endpoint', 'http://localhost:1234/v1');
    }
    ...
    public async getAvailableModels(): Promise<string[]> {
        try {
            ...
            this.errorHandler.handleError(error, 'Failed to fetch LM Studio models');
            return [];
        }
    }
    ...
    public async processTask(task: string): Promise<string> {
        ...
        try {
            ...
            this.errorHandler.handleError(error, 'Failed to process LM Studio task');
            throw error;
        }
    }
